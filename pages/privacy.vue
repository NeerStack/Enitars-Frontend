<template>
    <main>
        ...
        <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the
            ...
            created with the help of the <a>Privacy Policy Generator</a>.</p>
        ...
        <ul>
            ...
            <li>
                <p><strong>Application</strong> refers to Enitars, the software program provided by the Company.</p>
            </li>
            <li>
                <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                    &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Enitars.</p>
            </li>
            <li>
        ...
        <ul>
            <li>By email: support@neerstack.com</li>
        </ul>
                </div>
            </div>
        </div>
