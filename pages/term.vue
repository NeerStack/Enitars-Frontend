        ...
        <div class="container-xxl py-5">
            <div class="container py-5 px-lg-5">
                <div class="row g-5 align-items-center">
                    ...
                    <p>Welcome to Enitars!</p>

                    <p>These terms and conditions outline the rules and regulations for the use of Enitars's Website,
                        located at www.enitars.com.</p>

                    <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use
                        Enitars if you do not agree to take all of the terms and conditions stated on this page.</p>
                    ...
                    <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer
                        ...
                        services, in accordance with and subject to, prevailing law of ng. Any use of the above
                    ...
                    <p>We employ the use of cookies. By accessing Enitars, you agreed to use cookies in agreement with
                        the Enitars's Privacy Policy. </p>
                    ...
                    <p>Unless otherwise stated, Enitars and/or its licensors own the intellectual property rights for
                        all material on Enitars. All intellectual property rights are reserved. You may access this from
                        Enitars for your own personal use subjected to restrictions set in these terms and conditions.
                    </p>

                    <p>You must not:</p>
                    <ul>
                        <li>Republish material from Enitars</li>
                        <li>Sell, rent or sub-license material from Enitars</li>
                        <li>Reproduce, duplicate or copy material from Enitars</li>
                        <li>Redistribute content from Enitars</li>
                    </ul>
                    ...
                    <p>Parts of this website offer an opportunity for users to post and exchange opinions and
                        information in certain areas of the website. Enitars does not filter, edit, publish or review
                        Comments prior to their presence on the website. Comments do not reflect the views and opinions
                        of Enitars,its agents and/or affiliates. Comments reflect the views and opinions of the person
                        who post their views and opinions. To the extent permitted by applicable laws, Enitars shall not
                    ...
                    <p>Enitars reserves the right to monitor all Comments and to remove any Comments which can be
                    ...
                    <p>You hereby grant Enitars a non-exclusive license to use, reproduce, edit and authorize others to
                    ...
                    <p>We will approve link requests from these organizations if we decide that: (a) the link would not
                        ...
                        hyperlink compensates the absence of Enitars; and (d) the link is in the context of general
                    ...
                    <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to
                        our website, you must inform us by sending an e-mail to Enitars. Please include your name, your
                    ...
                    <p>No use of Enitars's logo or other artwork will be allowed for linking absent a trademark license
                        agreement.</p>
